...
def parse_args():
    ...
    parser.add_argument("--n-estimators", "--n_estimators", type=int, default=300)
    parser.add_argument("--max-depth", "--max_depth", type=int, default=6)
    parser.add_argument("--learning-rate", "--learning_rate", type=float, default=0.05)
    parser.add_argument("--subsample", type=float, default=0.8)
    parser.add_argument("--colsample-bytree", "--colsample_bytree", type=float, default=0.8)
    parser.add_argument("--scale-pos-weight", "--scale_pos_weight", type=float, default=10.0)
    parser.add_argument("--auc-threshold", "--auc_threshold", type=float, default=0.70)
